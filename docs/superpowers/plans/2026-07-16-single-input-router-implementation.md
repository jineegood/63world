...
2. Add browser regression cases from `docs/archive/audits/2026-07-16-input-routing-inventory.md`, starting with typing isolation and one-owner E/Escape paths.
