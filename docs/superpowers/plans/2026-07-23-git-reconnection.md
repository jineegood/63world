...
- [x] **Step 2: 작업용 대용량 폴더를 제외한 체크포인트 생성**
...
- [x] **Step 3: 빈 Git 폴더를 프로젝트 밖으로 보존하고 원격 메타데이터 복사**
