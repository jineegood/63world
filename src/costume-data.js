...
(function costumeDataV55() {
  ...
  const COSTUME_DEFS = {
    ...
    cs_sharkHood: {
      id: 'cs_sharkHood', name: '아기 상어 후드', slot: 'head', classOnly: null, price: 230, costume: true,
      desc: '동그란 눈과 삐죽한 이빨이 얼굴을 감싸는 익살스러운 아기 상어 후드.',
      look: { type: 'sharkHood', color: '#38bdf8' },
    },
    cs_starCrown: {
      id: 'cs_starCrown', name: '별빛 왕관', slot: 'head', classOnly: null, price: 310, costume: true,
      desc: '밤하늘의 별을 담은 왕관. 은은한 별빛이 반짝입니다.',
      look: { type: 'starCrown', color: '#fde68a' },
    },
    cs_violetMagicHat: {
      id: 'cs_violetMagicHat', name: '보랏빛 마법 모자', slot: 'head', classOnly: null, price: 350, costume: true,
      desc: '휘어진 달빛 고깔과 초승달 장식, 별가루가 맴도는 보랏빛 마법 모자.',
      look: { type: 'arcaneMoonHat', color: '#6d28d9' },
    },
    cs_ninjaMask: {
      id: 'cs_ninjaMask', name: '그림자 닌자 복면', slot: 'head', classOnly: null, price: 400, costume: true,
      desc: '눈빛만 드러나는 검은 닌자 복면. 말없이 서 있기만 해도 고수처럼 보입니다.',
      look: { type: 'ninjaMask', color: '#111827' },
    },
    cs_spartanHelm: {
      id: 'cs_spartanHelm', name: '스파르타 투구', slot: 'head', classOnly: null, price: 460, costume: true,
      desc: '붉은 말총 장식과 황동빛 얼굴 가리개가 달린 용맹한 전사 투구.',
      look: { type: 'spartanHelm', color: '#d97706' },
    },
    cs_blackDragonHelm: {
      id: 'cs_blackDragonHelm', name: '흑룡 뿔투구', slot: 'head', classOnly: null, price: 510, costume: true,
    ...
    cs_starryRobe: {
      id: 'cs_starryRobe', name: '별무리 로브', slot: 'armor', classOnly: null, price: 210, costume: true,
      desc: '밤하늘을 그대로 두른 로브. 별이 반짝이고 은하수가 흐릅니다.',
      look: { type: 'starryRobe', color: '#312e81' },
    },
    cs_sharkSuit: {
      id: 'cs_sharkSuit', name: '아기 상어 인형옷', slot: 'armor', classOnly: null, price: 270, costume: true,
      desc: '하얀 배와 통통한 옆지느러미가 달린 파란 상어 인형옷. 육지에서도 첨벙첨벙!',
      look: { type: 'sharkSuit', color: '#38bdf8' },
    },
    cs_peachDress: {
      id: 'cs_peachDress', name: '복숭아 드레스', slot: 'armor', classOnly: null, price: 270, costume: true,
      desc: '3단 프릴과 허리 리본이 살랑이는 드레스. 상남의 대표작입니다.',
      look: { type: 'peachDress', color: '#fda4af' },
    },
    cs_forestFairyCape: {
      id: 'cs_forestFairyCape', name: '숲요정 망토', slot: 'armor', classOnly: null, price: 300, costume: true,
      desc: '겹겹의 나뭇잎과 덩굴 깃, 도토리 브로치로 엮은 살아 있는 숲요정 망토.',
      look: { type: 'forestLeafMantle', color: '#15803d' },
    },
    cs_ninjaSuit: {
      id: 'cs_ninjaSuit', name: '그림자 닌자복', slot: 'armor', classOnly: null, price: 340, costume: true,
      desc: '붉은 허리띠와 교차 끈으로 단단히 여민 검은 닌자복. 발소리까지 작아질 것 같습니다.',
      look: { type: 'ninjaSuit', color: '#111827' },
    },
    cs_spartanArmor: {
      id: 'cs_spartanArmor', name: '스파르타 전투갑옷', slot: 'armor', classOnly: null, price: 420, costume: true,
      desc: '황동 흉갑과 붉은 전투 치마를 갖춘 스파르타식 갑옷. 오늘만큼은 물러서지 않습니다.',
      look: { type: 'spartanArmor', color: '#d97706' },
    },
    cs_blackDragonArmor: {
      id: 'cs_blackDragonArmor', name: '흑룡 비늘갑옷', slot: 'armor', classOnly: null, price: 530, costume: true,
    ...
    cs_duckFloat: {
      id: 'cs_duckFloat', name: '고무 오리 튜브', slot: 'accessory', classOnly: null, price: 220, costume: true,
      desc: '전투 중에도 물놀이 기분을 잃지 않게 해 주는 노란 고무 오리 튜브.',
      look: { type: 'duckFloat', color: '#facc15' },
    },
    cs_sharkBuddy: {
      id: 'cs_sharkBuddy', name: '아기 상어 친구', slot: 'accessory', classOnly: null, price: 250, costume: true,
      desc: '어깨 옆에서 보글보글 물방울을 내뿜으며 헤엄치는 통통한 아기 상어 친구.',
      look: { type: 'sharkBuddy', color: '#38bdf8' },
    },
    cs_angelWing: {
      id: 'cs_angelWing', name: '하얀 줄끈', slot: 'accessory', classOnly: null, price: 250, costume: true,
      desc: '어깨에서 등 뒤로 흘러내리는 하얀 리본 끈. 걸을 때마다 살랑입니다.',
      look: { type: 'ribbonStreamer', color: 'rgba(255,255,255,.96)' },
    },
    cs_strangeWing: {
      id: 'cs_strangeWing', name: '기묘한 날개', slot: 'accessory', classOnly: null, price: 290, costume: true,
      desc: '어디서 온 것인지 알 수 없는 기묘한 날개. 깃털이 층층이 겹쳐 묘한 분위기를 냅니다.',
      look: { type: 'angelWing', color: 'rgba(255,255,255,.96)' },
    },
    cs_rainbowAura: {
      id: 'cs_rainbowAura', name: '무지개 오라', slot: 'accessory', classOnly: null, price: 330, costume: true,
      desc: '발밑에서 일곱 빛깔이 맴도는 화려한 오라.',
      look: { type: 'rainbowAura', color: 'rgba(167,243,208,.55)' },
    },
    cs_twilightBatWing: {
      id: 'cs_twilightBatWing', name: '밤빛 박쥐 날개', slot: 'accessory', classOnly: null, price: 360, costume: true,
      desc: '보랏빛 황혼을 닮은 박쥐 날개. 움직일 때마다 날개 끝이 살짝 펄럭입니다.',
      look: { type: 'batWing', color: '#7c3aed' },
    },
    cs_blackDragonShield: {
      id: 'cs_blackDragonShield', name: '흑룡 가시방패', slot: 'accessory', classOnly: null, price: 480, costume: true,
