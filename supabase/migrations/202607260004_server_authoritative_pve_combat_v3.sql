...
create table if not exists public.game_monster_catalog_v3 (
  ...
  question_map text not null
    check (question_map in ('forest', 'desert', 'swamp')),
...
values
('desert_elite_snake','bossRoom','desert','snake',7,119,128,20,25,18,24,true,false,'[{"chance":0.37,"kind":"poison","turns":3},{"chance":0.27,"kind":"critical"},{"chance":0.18,"kind":"heavy","multiplier":1.5},{"chance":0.15,"kind":"selfShield","percent":0.225}]'::jsonb),
('desert_snake','desert','desert','snake',7,59,64,10,13,9,12,false,false,'[{"chance":0.25,"kind":"poison","turns":3},{"chance":0.15,"kind":"critical"}]'::jsonb),
('desert_stomp','desert','desert','stomp',5,41,44,7,9,6,9,false,false,'[{"chance":0.25,"kind":"heavy","multiplier":1.5,"stunTurns":1},{"chance":0.2,"kind":"selfShield","percent":0.3}]'::jsonb),
('final_teacher','finalBossRoom','swamp','teacherBoss',99,999,999,24,30,363,363,true,true,'[{"chance":0.25,"kind":"heavy","multiplier":1.6},{"chance":0.2,"kind":"multi","hits":2,"multiplier":0.72},{"chance":0.15,"kind":"chillPlayer","turns":1}]'::jsonb),
('forest_elite_slime','bossRoom','forest','slime',3,36,42,6,10,6,8,true,false,'[{"chance":0.37,"kind":"selfShield","percent":0.35},{"chance":0.18,"kind":"heavy","multiplier":1.5},{"chance":0.15,"kind":"selfShield","percent":0.225}]'::jsonb),
('forest_mushroom','forest','forest','mushroom',1,9,11,2,4,1,2,false,false,'[{"chance":0.22,"kind":"poison","turns":2}]'::jsonb),
('forest_slime','forest','forest','slime',3,20,23,3,5,3,4,false,false,'[{"chance":0.25,"kind":"selfShield","percent":0.35}]'::jsonb),
('swamp_elite_zombie','bossRoom','swamp','zombie',11,382,399,29,34,30,40,true,false,'[{"chance":0.37,"kind":"lifesteal","percent":1},{"chance":0.18,"kind":"heavy","multiplier":1.5},{"chance":0.15,"kind":"selfShield","percent":0.225}]'::jsonb),
('swamp_tarantula','swamp','swamp','tarantula',9,62,66,11,13,12,15,false,false,'[{"chance":0.3,"kind":"multi","hits":2,"multiplier":0.62},{"chance":0.2,"kind":"heavy","multiplier":1.3,"stunTurns":1}]'::jsonb),
('swamp_zombie','swamp','swamp','zombie',11,91,95,24,28,16,20,false,false,'[{"chance":0.25,"kind":"lifesteal","percent":1}]'::jsonb)
...
begin
  ...
  v_question := public.private_pick_combat_question_v3(v_monster.question_map);
